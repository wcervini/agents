...
Skills personalizadas para el agente **opencode** que uso para agilizar procesos y estandarizar tareas repetitivas en mi flujo de desarrollo.

## Skills disponibles

| Skill | Descripción |
|-------|-------------|
| [astro](skills/astro/SKILL.md) | Construcción con Astro: componentes, SSR, adaptadores, content collections, despliegue |
| [astro-framework](skills/astro-framework/SKILL.md) | Especialista en Astro framework: componentes, islands, Content Layer, SSR, i18n |
...
| [modern-web-guidance](skills/modern-web-guidance/SKILL.md) | Guía de APIs web modernas: View Transitions, Scroll-driven animations, CSS avanzado |
| [vscode-snippets](skills/vscode-snippets/SKILL.md) | Genera snippets de VS Code a partir de código seleccionado |

## Cómo usar

Cada skill se activa automáticamente según la tarea que le pidas al agente. También puedes invocarlas explícitamente.
