---
name: gitmoji-reference
description: Full reference table of gitmojis for Conventional Commits with gitmoji.
---

# Gitmoji Reference

Complete list of available gitmojis for commit messages.
